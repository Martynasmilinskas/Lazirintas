...
if (!isset($_SESSION['prev']) || (($_SESSION['prev'] != "procadmin") && ($_SESSION['prev'] != "procadmindb") 
								  &&  ($_SESSION['prev'] != "procregister") &&  ($_SESSION['prev'] != "index")))
...
<html>
    ...
    <body>
        ...
        <center><img src="top1.png" width="600" height="500"></center>
            </td></tr><tr><td>
				<div style="text-align: center;color:#FFFFFF"> <br><br> 
...
?>
    ...
    <tr><td><b>Vartotojo vardas</b></td><td><b>Rolė</b></td><td><b>E-paštas</b></td><td><b>Paskutinį kartą aktyvus</b></td></tr>
<?php
